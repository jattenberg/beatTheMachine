...
\includegraphics[width= 0.4\columnwidth]{plots/decreasing_UU-KU_150_3knn.png}
\label{fig:150}
}
%\drop{
...
\includegraphics[width= 0.4\columnwidth]{plots/decreasing_UU-KU_1500_3knn.png}
\label{fig:1500}
}
\subfigure[$15,000$ $k$-NN Training Examples]{
\includegraphics[width= 0.4\columnwidth]{plots/decreasing_UU-KU_15000_3knn.png}
\label{fig:15000}
}
}
